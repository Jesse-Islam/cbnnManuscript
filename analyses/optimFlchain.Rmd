...
```{r flchainPrep,eval=FALSE,hide=FALSE}
...
##saveRDS(res$test,"flchainTest.rds")
...
##saveRDS(winners,"flchainWins.rds")

```

```{r bestFits,finalFit}

winners<-readRDS("flchainWins.rds")
...
while (pos <= iteration) {
  ...
  fullTest<-readRDS("flchainTest.rds")

...
fitSmoothHaz<-function(pmnn,epochs=2000,batch_size=500,verbose=0,monitor="val_loss",val_split=0.2,min_delta=10^-7,patience=10,val){
  #pmnn$casebaseData
...
fitSmoothHazSpline<-function(pmnn,epochs=2000,batch_size=500,verbose=0,monitor="val_loss",val_split=0.2,min_delta=10^-7,patience=10,val){
  #pmnn$casebaseData

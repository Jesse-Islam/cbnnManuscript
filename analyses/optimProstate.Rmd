...
```{r prostatePrep,eval=TRUE,hide=FALSE}
...
#saveRDS(res$test,"cvData/prostateTest.rds")
...
#saveRDS(klist,"cvData/prostateCV.rds")
...
klist<-readRDS("cvData/prostateCV.rds")
...
#saveRDS(winners,"cvData/prostateWins.rds")

```

```{r bestFits,finalFit}

winners<-readRDS("cvData/prostateWins.rds")
...
while (pos <= iteration) {
  ...
  fullTest<-readRDS("cvData/prostateTest.rds")

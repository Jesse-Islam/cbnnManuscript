...
cMax<-max(readRDS("ComplexSimTest.rds")$time)/365
mMax<-max(readRDS("myelomaTest.rds")$time)/365
fMax<-max(readRDS("flchainTest.rds")$time)/365
pMax<-max(readRDS("prostateTest.rds")$time)/12
...
cwtab<-getWinsTable("complexOptimWins.rds","A: Complex")
mwtab<-getWinsTable("myelomaWins.rds","B: MM")
fwtab<-getWinsTable("flchainWins.rds","C: FLC")
pwtab<-getWinsTable("prostateWins.rds","D: Prostate")

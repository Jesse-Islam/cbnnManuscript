...
```{r myelomaPrep,eval=FALSE,hide=FALSE}
...
#saveRDS(res$test,"myelomaTest.rds")
...
#saveRDS(winners,"myelomaWins.rds")

```

```{r bestFits,finalFit}

winners<-readRDS("myelomaWins.rds")
...
while (pos <= iteration) {
  ...
  fullTest<-readRDS("myelomaTest.rds")
